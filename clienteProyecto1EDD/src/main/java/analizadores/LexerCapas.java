...
public class LexerCapas implements java_cup.runtime.Scanner {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    ...
    "\10\0\1\3\3\0\12\4\1\0\1\5\5\0\6\6"+
    "\32\0\6\6\24\0\1\7\1\0\1\10\u0182\0";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    "\0\0\0\11\0\22\0\33\0\11\0\44\0\11\0\11"+
    "\0\11\0\33";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\1\11\12\0\1\3\13\0\1\12\1\0\1\12\6\0"+
    "\1\6\4\0";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 =
    "\1\0\1\11\2\1\1\11\1\1\3\11\1\1";
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1:
            { error(yytext()); new Symbol(symC.error,yyline,yycolumn, yytext());
            }
            // fall through
          case 9: break;
          case 2:
          ...
          case 15: break;
          case 8:
            { return new Symbol(symC.HEXA,yyline+1,yycolumn+1, yytext());
            }
            // fall through
          case 16: break;
          default:
  ...
  public static void main(String[] argv) {
    if (argv.length == 0) {
      System.out.println("Usage : java LexerCapas [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        LexerCapas scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new LexerCapas(reader);
